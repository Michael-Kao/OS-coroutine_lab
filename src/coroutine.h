 ...
 * coroutine API
 * TODO:
 * 1. use array of pointer to store the stack variables. So it may change the
...
#define CR_STACK 0x0003

#define CR_SCHED_MASK (CR_DEFAULT | CR_FIFO | CR_STACK)
...
/*
 * The macro to define the variable of job function
...
/*
 * The macro to define the two variables of job function
 * It must happens before the cr_begin macro.
 */
...
/*
 * The macro to define the three variables of job function
 * It must happens before the cr_begin macro.
 */
